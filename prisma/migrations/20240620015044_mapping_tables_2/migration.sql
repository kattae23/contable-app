...
CREATE TABLE "categoriesas" (
    ...
    CONSTRAINT "categoriesas_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "user_email_name_lastName_second_last_name_legal_name_image_idx" ON "user"("email", "name", "lastName", "second_last_name", "legal_name", "image");
...
-- AddForeignKey
ALTER TABLE "categoriesas" ADD CONSTRAINT "categoriesas_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "expenses" ADD CONSTRAINT "expenses_categorieId_fkey" FOREIGN KEY ("categorieId") REFERENCES "categoriesas"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_categorieId_fkey" FOREIGN KEY ("categorieId") REFERENCES "categoriesas"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
